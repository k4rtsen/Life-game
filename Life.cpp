...
// Игровое поле размером __WORLD_HEIGHT__ на __WORLD_WIDTH__ клеток
...
//Kопирование игрового мира. Используется для сохранения предыдущего поколения
...
int main(void)
{
	...
	//Вывод последнего состояния поля
	print_world(world);
